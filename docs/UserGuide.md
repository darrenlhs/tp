...
| Tag                            | A label attached to a contact, used for categorising or leaving brief notes about them (e.g. `friends`, `classmates`, `computing`). Tags can be alphanumeric, contain spaces and special characters, except for the backslash (`/`)        |
